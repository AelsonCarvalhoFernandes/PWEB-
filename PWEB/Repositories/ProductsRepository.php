...
class ProductRepository{
    ...
    function update($id, $name, $quant, $category, $price, $description, $update_at) {
        $conn = $this->connection->getConnection();
        $sql = "UPDATE Product SET name = '$name', quantity = '$quant', category = '$category', price = '$price', description = '$description', update_date = '$update_at' WHERE id = $id";
